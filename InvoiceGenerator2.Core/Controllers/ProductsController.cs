...
using InvoiceGenerator2.Models.ViewModels.Products;
...
namespace InvoiceGenerator2.Core.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(ApplicationDbContext context, TDCDbContext tdcDbContext, IWebHostEnvironment environment)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult> Upload(UploadProductViewModel data)
        {
            if (data.File != null)
            {
                ...
                if (filename.EndsWith(".xls") || filename.EndsWith(".xlsx"))
                {
                    ...
                    string path =  Path.Combine(_environment.WebRootPath, "TempUploads");
